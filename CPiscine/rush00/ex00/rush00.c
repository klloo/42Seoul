...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/12 14:01:50 by heeyjang          #+#    #+#             */
/*   Updated: 2023/02/12 18:16:24 by heeyjang         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_write_char(int x, int y, int curx, int cury)
{
	if ((curx == 0 && cury == 0) || (curx == x - 1 && cury == 0))
		ft_putchar('o');
	else if ((curx == 0 && cury == y - 1) || (curx == x - 1 && cury == y - 1))
		ft_putchar('o');
	else if (curx == 0 || curx == x - 1)
		ft_putchar('|');
	else if (cury == 0 || cury == y - 1)
		ft_putchar('-');
	else
		ft_putchar(' ');
}
