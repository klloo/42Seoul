...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/12 14:09:11 by heeyjang          #+#    #+#             */
/*   Updated: 2023/02/12 18:16:48 by heeyjang         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if ((curx == 0 && cury == 0) || (curx == 0 && cury == y - 1))
		ft_putchar('A');
	else if ((curx == x - 1 && cury == y - 1) || (curx == x - 1 && cury == 0))
		ft_putchar('C');
